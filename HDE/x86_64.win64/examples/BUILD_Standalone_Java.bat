...
cd %~dp0
echo call dcps/RoundTrip/java/BUILD_Saj_RoundTrip_Types.bat %*
call dcps/RoundTrip/java/BUILD_Saj_RoundTrip_Types.bat %*
IF NOT %ERRORLEVEL% == 0 (
ECHO:
ECHO *** Error building dcps/RoundTrip/java/BUILD_Saj_RoundTrip_Types.bat
ECHO:
GOTO error
)
cd %~dp0
echo call dcps/RoundTrip/java/BUILD_Saj_RoundTrip_Ping.bat %*
call dcps/RoundTrip/java/BUILD_Saj_RoundTrip_Ping.bat %*
IF NOT %ERRORLEVEL% == 0 (
ECHO:
ECHO *** Error building dcps/RoundTrip/java/BUILD_Saj_RoundTrip_Ping.bat
ECHO:
GOTO error
)
cd %~dp0
echo call dcps/RoundTrip/java/BUILD_Saj_RoundTrip_Pong.bat %*
call dcps/RoundTrip/java/BUILD_Saj_RoundTrip_Pong.bat %*
IF NOT %ERRORLEVEL% == 0 (
ECHO:
ECHO *** Error building dcps/RoundTrip/java/BUILD_Saj_RoundTrip_Pong.bat
ECHO:
GOTO error
)
cd %~dp0
echo call dcps/Throughput/java/BUILD_Saj_Throughput_Types.bat %*
call dcps/Throughput/java/BUILD_Saj_Throughput_Types.bat %*
IF NOT %ERRORLEVEL% == 0 (
ECHO:
ECHO *** Error building dcps/Throughput/java/BUILD_Saj_Throughput_Types.bat
ECHO:
GOTO error
)
cd %~dp0
echo call dcps/Throughput/java/BUILD_Saj_Throughput_Publisher.bat %*
call dcps/Throughput/java/BUILD_Saj_Throughput_Publisher.bat %*
IF NOT %ERRORLEVEL% == 0 (
ECHO:
ECHO *** Error building dcps/Throughput/java/BUILD_Saj_Throughput_Publisher.bat
ECHO:
GOTO error
)
cd %~dp0
echo call dcps/Throughput/java/BUILD_Saj_Throughput_Subscriber.bat %*
call dcps/Throughput/java/BUILD_Saj_Throughput_Subscriber.bat %*
IF NOT %ERRORLEVEL% == 0 (
ECHO:
ECHO *** Error building dcps/Throughput/java/BUILD_Saj_Throughput_Subscriber.bat
ECHO:
GOTO error
)
cd %~dp0
