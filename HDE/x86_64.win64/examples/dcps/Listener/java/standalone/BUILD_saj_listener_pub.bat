...
del /f/s/q classes\ListenerDataPublisher.class classes\DDSEntityManager.class classes\ErrorHandler.class classes\ListenerDataListener.class 2>nul
...
echo pushd classes\ ^& jar %JARFLAGS% %JARFILE% %MANIFEST%  ListenerDataPublisher.class DDSEntityManager.class ErrorHandler.class ListenerDataListener.class ListenerDataListener.class ^& popd
pushd classes\ & jar %JARFLAGS% %JARFILE% %MANIFEST%  ListenerDataPublisher.class DDSEntityManager.class ErrorHandler.class ListenerDataListener.class ListenerDataListener.class & popd
