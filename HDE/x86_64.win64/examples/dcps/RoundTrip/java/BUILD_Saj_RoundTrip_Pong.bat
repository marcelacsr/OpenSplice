...
set MAINCLASS=pong
set JARFILE=Saj_RoundTrip_Pong.jar
set MANIFEST=Saj_RoundTrip_Pong.manifest
...
del /f/s/q classes\pong.class classes\Pong_impl.class classes\Entities.class classes\ExampleUtilities.class classes\ExampleError.class 2>nul
del /f/s/q classes\Pong_impl*.class & del /f/s/q classes\ExampleUtilities*.class  2>nul
...
echo javac -cp "Saj_RoundTrip_Types.jar;classes\;..\..\..\..\jar\dcpssaj.jar;" -d classes\ pong.java
javac -cp "Saj_RoundTrip_Types.jar;classes\;..\..\..\..\jar\dcpssaj.jar;" -d classes\ pong.java
IF NOT %ERRORLEVEL% == 0 (
  ECHO:
...
echo javac -cp "Saj_RoundTrip_Types.jar;classes\;..\..\..\..\jar\dcpssaj.jar;" -d classes\ Pong_impl.java
javac -cp "Saj_RoundTrip_Types.jar;classes\;..\..\..\..\jar\dcpssaj.jar;" -d classes\ Pong_impl.java
IF NOT %ERRORLEVEL% == 0 (
  ECHO:
...
echo pushd classes\ ^& jar %JARFLAGS% %JARFILE% %MANIFEST%  pong.class Pong_impl.class Entities.class ExampleUtilities.class ExampleError.class Pong_impl*.class ExampleUtilities*.class ^& popd
pushd classes\ & jar %JARFLAGS% %JARFILE% %MANIFEST%  pong.class Pong_impl.class Entities.class ExampleUtilities.class ExampleError.class Pong_impl*.class ExampleUtilities*.class & popd
