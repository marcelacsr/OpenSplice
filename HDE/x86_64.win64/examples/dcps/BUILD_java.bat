...
cd %~dp0
echo call RoundTrip/java/BUILD_Saj_RoundTrip_Types.bat %*
call RoundTrip/java/BUILD_Saj_RoundTrip_Types.bat %*
IF NOT %ERRORLEVEL% == 0 (
ECHO:
ECHO *** Error building RoundTrip/java/BUILD_Saj_RoundTrip_Types.bat
ECHO:
GOTO error
)
cd %~dp0
echo call RoundTrip/java/BUILD_Saj_RoundTrip_Ping.bat %*
call RoundTrip/java/BUILD_Saj_RoundTrip_Ping.bat %*
IF NOT %ERRORLEVEL% == 0 (
ECHO:
ECHO *** Error building RoundTrip/java/BUILD_Saj_RoundTrip_Ping.bat
ECHO:
GOTO error
)
cd %~dp0
echo call RoundTrip/java/BUILD_Saj_RoundTrip_Pong.bat %*
call RoundTrip/java/BUILD_Saj_RoundTrip_Pong.bat %*
IF NOT %ERRORLEVEL% == 0 (
ECHO:
ECHO *** Error building RoundTrip/java/BUILD_Saj_RoundTrip_Pong.bat
ECHO:
GOTO error
)
cd %~dp0
echo call Throughput/java/BUILD_Saj_Throughput_Types.bat %*
call Throughput/java/BUILD_Saj_Throughput_Types.bat %*
IF NOT %ERRORLEVEL% == 0 (
ECHO:
ECHO *** Error building Throughput/java/BUILD_Saj_Throughput_Types.bat
ECHO:
GOTO error
)
cd %~dp0
echo call Throughput/java/BUILD_Saj_Throughput_Publisher.bat %*
call Throughput/java/BUILD_Saj_Throughput_Publisher.bat %*
IF NOT %ERRORLEVEL% == 0 (
ECHO:
ECHO *** Error building Throughput/java/BUILD_Saj_Throughput_Publisher.bat
ECHO:
GOTO error
)
cd %~dp0
echo call Throughput/java/BUILD_Saj_Throughput_Subscriber.bat %*
call Throughput/java/BUILD_Saj_Throughput_Subscriber.bat %*
IF NOT %ERRORLEVEL% == 0 (
ECHO:
ECHO *** Error building Throughput/java/BUILD_Saj_Throughput_Subscriber.bat
ECHO:
GOTO error
)
cd %~dp0
